...
public class WebDriverHelpers {
    ...
    public boolean checkPageUrlToBe(String url) {
        return new WebDriverWait(driver, DRIVER_WAIT_TIME).until(ExpectedConditions.urlToBe(url));
    }
    ...
    public boolean checkPageUrlContains(String fraction) {
        return new WebDriverWait(driver, DRIVER_WAIT_TIME).until(ExpectedConditions.urlContains(fraction));
    }
    ...
    public boolean checkPageUrlMatches(String regex) {
        return new WebDriverWait(driver, DRIVER_WAIT_TIME).until(ExpectedConditions.urlMatches(regex));
    }
    ...
    public WebDriver frameToBeAvailableAndSwitchToIt(final String frameLocator) {
        return new WebDriverWait(driver, DRIVER_WAIT_TIME).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(frameLocator));
    }
    ...
    public WebDriver frameToBeAvailableAndSwitchToIt(final By by) {
        return new WebDriverWait(driver, DRIVER_WAIT_TIME).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(by));
    }
    ...
    public boolean stalenessOf(final WebElement element) {
        return (new WebDriverWait(driver, DRIVER_WAIT_TIME)).until(ExpectedConditions.stalenessOf(element));
    }
    ...
    public boolean elementToBeSelected(final By by) {
        return (new WebDriverWait(driver, DRIVER_WAIT_TIME)).until(ExpectedConditions.elementToBeSelected(by));
    }
    ...
    public boolean elementToBeSelected(final WebElement element) {
        return (new WebDriverWait(driver, DRIVER_WAIT_TIME)).until(ExpectedConditions.elementToBeSelected(element));
    }
    ...
    public boolean elementSelectionStateToBe(final WebElement element, final boolean selected) {
        return (new WebDriverWait(driver, DRIVER_WAIT_TIME)).until(ExpectedConditions.elementSelectionStateToBe(element, selected));
    }
    ...
    public boolean elementSelectionStateToBe(final By by,
        ...
        return (new WebDriverWait(driver, DRIVER_WAIT_TIME)).until(ExpectedConditions.elementSelectionStateToBe(by, selected));
    }

    public void waitForAlert() {
        (new WebDriverWait(driver, DRIVER_WAIT_TIME)).until(ExpectedConditions.alertIsPresent());
    }
    ...
    public List<WebElement> visibilityOfAllElementsLocatedBy(final By by) {
        return (new WebDriverWait(driver, DRIVER_WAIT_TIME)).until(ExpectedConditions.visibilityOfAllElementsLocatedBy(by));
    }
    ...
    public List<WebElement> visibilityOfAllElements(final List<WebElement> elements) {
        return (new WebDriverWait(driver, DRIVER_WAIT_TIME)).until(ExpectedConditions.visibilityOfAllElements(elements));
    }
    ...
    public List<WebElement> presenceOfAllElementsLocatedBy(final By by) {
        return (new WebDriverWait(driver, DRIVER_WAIT_TIME)).until(ExpectedConditions.presenceOfAllElementsLocatedBy(by));
    }
